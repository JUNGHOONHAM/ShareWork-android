...
class SendPhoneNumberNetworkDataSource (private val apiService : DBInterface, private val compositeDisposable : CompositeDisposable) {
    ...
    fun sendPhoneNumber(phoneNumber: String) {
        ...
        try {
            compositeDisposable.add(
                apiService.sendPhoneNumber(SmsAuthRequest(phoneNumber, null, null))
